...
public class InstituteAllFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.showinstutute_layout, container, false);
				
	      dbHelper=new DatabaseHelper(getActivity(),SQLiteDatabase.OPEN_READWRITE);
	      dbHelper.createDatabase();
	      db =  dbHelper.openDatabase();
	      
	      cursor=DatabaseManager.getOrgbyinstitute(db, dbconfig.TABLE_Org, dbconfig.COLUMNS_Org);
	      
	      
	      lv=(ListView)rootView.findViewById(R.id.lv_place);
	      
	      lv.setAdapter(new InstituteAdapter(getActivity()));
	...
	// Adapter
		class InstituteAdapter extends BaseAdapter{
			
			private LayoutInflater inflater;
			private Activity context;
			public InstituteAdapter(Activity ct){
				context=ct;
